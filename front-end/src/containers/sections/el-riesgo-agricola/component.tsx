  ...
  return (
    <section className="relative">
      <MediaContextProvider>
        ...
        <Mobile>
          <div className="w-full bg-primary-black" id="section-el-riesgo-agricola">
            <div className="flex flex-col items-start w-full max-w-screen-lg px-2 pt-32 mx-auto bg-primary-black">
              <h1 className="relative px-2 py-1 font-serif text-3xl transition-opacity duration-500 text-primary-black">
                <span className="relative z-10">El riesgo agrícola</span>
                <motion.div
                  initial={{ width: 0 }}
                  whileInView={{ width: '100%' }}
            ...
            <div className="flex flex-col items-start w-full max-w-screen-xl pb-8 mx-auto">
              <div className="w-full">
                <ChartProduccionesCultivos mobile={true} />
              </div>
            </div>
            <div className="flex w-full max-w-screen-lg pt-4 pb-12 mx-auto">
