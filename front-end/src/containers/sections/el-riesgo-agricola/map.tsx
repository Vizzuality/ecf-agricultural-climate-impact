...
export const ElRiesgoAgricolaMap: FC<ElRiesgoAgricolaMapTypes> = ({
  ...
  return (
    <div className="relative w-full bg-lightest-grey">
        ...
        <div>
          ...
          >
            <div>
              ...
              <div className="mt-12 text-lg">
                ...
                cultivos (y sus distintas variedades), y también a la variabilidad geográfica de las
                consecuencias del cambio climático. A continuación, exploramos los efectos del
          ...
          >
            <div>
              ...
              <div className="mt-12 text-lg">
                <p>
                  Cultivado desde el tiempo de los fenicios y los romanos, la producción oleícola ha
                  convertido a España en el principal productor y exportador mundial de aceite de
                  oliva.
                </p>
                <p>
                  <strong>
          ...
          >
            <div>
              <div className="mt-12 text-lg">
                <p>
                  Sin embargo, <strong>Andalucía</strong> –al igual que todo el sureste peninsular–
                  también es una de las regiones que van a sufrir mayor{' '}
                ...
                <p>
                  ...
                  rendimiento en al menos un 3.5% y 7% si se superan los 1,5 ºC en más de 11% y 23%
                  respectivamente a partir de los 3 ºC de calentamiento.
                </p>
              </div>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="mt-12 text-lg">
                <p>
                  ...
                  (6MHa). El 90% de la producción se destina a cereales de invierno, trigo y cebada
                  principalmente, casi en su totalidad (90%) de secano, y la mayoría se destina a
                  piensos.
                </p>
                <p>
                  <strong>
                  ...
                  , se predice que las temperaturas podrían aumentar entre 1,6 y 2ºC en los próximos
                  30 años.
                </p>
              </div>
            </div>
          ...
          >
            <div>
              <div className="font-serif text-2xl">Superficie destinada al cultivo de cereales</div>
              <div className="mt-12 text-lg">
          ...
          >
            <div>
              ...
              <div className="mt-12 text-lg">
                La calidad de las multiples variedades del vino español está reconocida globalmente.
                Esta diversidad en variedades de uva y la calidad final del vino responde a las
                distintas condiciones ambientales del territorio español: suelos, regímenes de
                precipitación, variaciones térmicas diurnas y estacionales, frecuencia e intensidad
                de heladas...
              </div>
            </div>
          </div>
          ...
          >
            <div>
              <div className="mt-12 text-lg">
                Aunque el viñedo es una planta fuertemente adaptada a las condiciones mediterráneas
                y que necesita déficits hídricos moderados para potenciar su calidad, el aumento
                eventos climáticos extremos como olas de calor, períodos de sequía más extremos,
                descenso de la precipitación pero cada vez más concentrada en lluvias torrenciales
                tendría efectos negativos en calidad y rendimiento, además de aumentar la erosión de
                los suelos.
              </div>
            </div>
          </div>
          ...
          >
            <div>
              ...
              <div className="mt-12 text-lg">
                <p>
                  La dehesa es un ejemplo ideal de gestión sostenible de un ecosistema mediterráneo
                  con una <strong>extensión de 2.5 mHa</strong> particularmente centradas en el
                ...
                <p>
                  ...
                  dehesa constituye el medio para el desarrollo de explotaciones de cerdos, ovejas,
                  caballos y toros de gran valor a nivel nacional.
                </p>
              </div>
            </div>
          </div>
          ...
          >
            <div>
              ...
              <div className="mt-12 text-lg">
                ...
                <p>
                  El aumento de la temperatura o la reducción de las precipitaciones podría derivar
                  por una parte en una menor producción vegetal, y por otra parte en el agostamiento
                  de la vegetación herbácea. Como consecuencia, esto podría reducir la capacidad de
                  carga animal por unidad de superficie y un posible déficit en la calidad de la
                  dieta animal – menor digestibilidad, menor contenido en proteínas.
                </p>
              </div>
            </div>
          </div>
          ...
          >
            <div>
              ...
              <div className="mt-12 text-lg">
                <p>
                  La pérdida de biodiversidad vegetal causada por la aridez se podría ver empeorada
                  por un mayor riesgo de incendios, que favorecería el crecimiento de especies
                  pirófitas y menos nutritivas para el ganado y especies de interés cinegético.
                </p>
                <p>
                  Aunque el volumen de producción en dehesas no es comparable al de zonas de
                  agricultura intensiva, la calidad de los productos y el impacto económico sobre la
                  población local son significativos y reconocidos. Prevenir las consecuencias del
                  cambio climático no solo protegerá la explotación sostenible de las dehesas y sus
                  beneficios sociales, sino también el ecosistema natural.
                </p>
              </div>
            </div>
          </div>
      ...
      {/* SCROLLAMA */}
      <Scrollama onStepEnter={onStepEnter} progress onStepProgress={onStepProgress} offset={0.5}>
