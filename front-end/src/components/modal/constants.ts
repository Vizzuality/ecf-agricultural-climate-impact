export const COMMON_CONTENT_CLASSES =
  'absolute top-1/2 inset-x-4 left-1/2 transform -translate-y-1/2 sm:-translate-x-1/2 outline-none bg-white flex flex-col flex-grow overflow-auto py-7';
export const CONTENT_CLASSES = {
  ...
  wide: `w-11/12 sm:w-10/12 md:w-10/12 lg:w-10/12 xl:w-8/12 ${COMMON_CONTENT_CLASSES}`,
};
